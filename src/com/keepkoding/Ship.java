...
abstract class Ship {
    ...
    Ship(Description d, double xVel, double yVel) {
        ...
        switch(randCoord(0,3)) {
            case 0: this.x = randCoord(-1 * errorRange, 0);
                this.y = randCoord(-1 * errorRange, SpaceShooter.screenHeight + errorRange);
                break;
            case 1: this.x = randCoord(SpaceShooter.screenWidth, SpaceShooter.screenWidth + errorRange);
                this.y = randCoord(-1 * errorRange, SpaceShooter.screenHeight + errorRange);
                break;
            case 2: this.y = randCoord(-1 * errorRange, 0);
                this.x = randCoord(-1 * errorRange, SpaceShooter.screenWidth + errorRange);
                break;
            case 3: this.y = randCoord(SpaceShooter.screenHeight, SpaceShooter.screenHeight + errorRange);
                this.x = randCoord(-1 * errorRange, SpaceShooter.screenWidth + errorRange);
                break;
        }
        this.setXVel(xVel);
